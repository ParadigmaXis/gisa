...
namespace GISAServer.Hibernate
{
    public class Assunto
    {
        ...
        public string TipoNoticia
        {
            get { return this.tipoNoticia; }
            set { this.tipoNoticia = value; }
        }
        ...
        public Assunto(long idControloAut)
        {            
            // Id:
            ...
            try
            {
                ...
                this.TipoNoticia = ca.TipoNoticiaAut.Designacao;
